...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__liepa

#else
#  define SWIG_init    init_liepa

#endif
#define SWIG_name    "_liepa"
...
SWIGINTERN PyObject *_wrap_init(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg2 = (char *)(buf2);
  result = (int)init((char const *)arg1,(char const *)arg2);
...
SWIGINTERN PyObject *_wrap_synth(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  char *arg1 = (char *) 0 ;
  short *arg2 = (short *) 0 ;
  size_t arg3 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOO:synth",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  res1 = SWIG_AsCharPtrAndSize(obj0, &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "synth" "', argument " "1"" of type '" "char *""'");
  }
  arg1 = (char *)(buf1);
  {
    npy_intp dims[1];
  ...
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "synth" "', argument " "4"" of type '" "int""'");
  } 
  arg4 = (int)(val4);
  ecode5 = SWIG_AsVal_int(obj3, &val5);
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "synth" "', argument " "5"" of type '" "int""'");
  } 
  arg5 = (int)(val5);
  result = (int)synth(arg1,arg2,arg3,arg4,arg5);
  resultobj = SWIG_From_int((int)(result));
  {
...
SWIGINTERN PyObject *_wrap_toWav(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  size_t arg1 ;
  short *arg2 = (short *) 0 ;
  char *arg3 = (char *) 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:toWav",&obj0,&obj1)) SWIG_fail;
  {
    npy_intp size[1] = {
      -1
    };
    ...
    arg2 = (short*) array_data(array1);
  }
  res3 = SWIG_AsCharPtrAndSize(obj1, &buf3, NULL, &alloc3);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "toWav" "', argument " "3"" of type '" "char *""'");
  }
  arg3 = (char *)(buf3);
  result = (int)toWav(arg1,arg2,arg3);
  resultobj = SWIG_From_int((int)(result));
  {
...
SWIGINTERN PyObject *_wrap_unload(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)":unload")) SWIG_fail;
  unload();
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "synth", _wrap_synth, METH_VARARGS, NULL},
	 { "toWav", _wrap_toWav, METH_VARARGS, NULL},
	 { "unload", _wrap_unload, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
